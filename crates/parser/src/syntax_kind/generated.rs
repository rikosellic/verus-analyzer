...
macro_rules ! T_ {
    ...
    [=~~=] => { $ crate :: SyntaxKind :: DEEP_EXT_EQ };
    [!~~=] => { $ crate :: SyntaxKind :: DEEP_EXT_NE };
    ...
    [prover] => { $ crate :: SyntaxKind :: PROVER_KW };
    ...
    [reveal_fn] => { $ crate :: SyntaxKind :: REVEAL_FN_KW };
