...
impl ast::HasDocComments for AssumeSpecification {}
...
impl ast::HasDocComments for BroadcastUse {}
impl BroadcastUse {
    #[inline]
...
impl ast::HasDocComments for VerusGlobal {}
impl VerusGlobal {
    #[inline]
    pub fn ty(&self) -> Option<Type> { support::child(&self.syntax) }
    #[inline]
...
impl hash::Hash for BroadcastGroupIdentifier {
    fn hash<H: hash::Hasher>(&self, state: &mut H) { self.syntax.hash(state); }
}
impl Eq for BroadcastGroupIdentifier {}
impl PartialEq for BroadcastGroupIdentifier {
    fn eq(&self, other: &Self) -> bool { self.syntax == other.syntax }
}
impl Clone for BroadcastGroupIdentifier {
    fn clone(&self) -> Self { Self { syntax: self.syntax.clone() } }
}
impl fmt::Debug for BroadcastGroupIdentifier {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("BroadcastGroupIdentifier").field("syntax", &self.syntax).finish()
    }
}
...
impl hash::Hash for BroadcastGroupList {
    fn hash<H: hash::Hasher>(&self, state: &mut H) { self.syntax.hash(state); }
}
impl Eq for BroadcastGroupList {}
impl PartialEq for BroadcastGroupList {
    fn eq(&self, other: &Self) -> bool { self.syntax == other.syntax }
}
impl Clone for BroadcastGroupList {
    fn clone(&self) -> Self { Self { syntax: self.syntax.clone() } }
}
impl fmt::Debug for BroadcastGroupList {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("BroadcastGroupList").field("syntax", &self.syntax).finish()
    }
}
...
impl hash::Hash for BroadcastGroupMember {
    fn hash<H: hash::Hasher>(&self, state: &mut H) { self.syntax.hash(state); }
}
impl Eq for BroadcastGroupMember {}
impl PartialEq for BroadcastGroupMember {
    fn eq(&self, other: &Self) -> bool { self.syntax == other.syntax }
}
impl Clone for BroadcastGroupMember {
    fn clone(&self) -> Self { Self { syntax: self.syntax.clone() } }
}
impl fmt::Debug for BroadcastGroupMember {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("BroadcastGroupMember").field("syntax", &self.syntax).finish()
    }
}
...
impl hash::Hash for BroadcastUseList {
    fn hash<H: hash::Hasher>(&self, state: &mut H) { self.syntax.hash(state); }
}
impl Eq for BroadcastUseList {}
impl PartialEq for BroadcastUseList {
    fn eq(&self, other: &Self) -> bool { self.syntax == other.syntax }
}
impl Clone for BroadcastUseList {
    fn clone(&self) -> Self { Self { syntax: self.syntax.clone() } }
}
impl fmt::Debug for BroadcastUseList {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("BroadcastUseList").field("syntax", &self.syntax).finish()
    }
}
...
impl hash::Hash for ModeSpecChecked {
    fn hash<H: hash::Hasher>(&self, state: &mut H) { self.syntax.hash(state); }
}
...
impl fmt::Debug for ModeSpecChecked {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("ModeSpecChecked").field("syntax", &self.syntax).finish()
    }
}
...
impl From<BroadcastGroupMember> for AnyHasAttrs {
    #[inline]
    fn from(node: BroadcastGroupMember) -> AnyHasAttrs { AnyHasAttrs { syntax: node.syntax } }
}
...
impl From<AssumeSpecification> for AnyHasDocComments {
    #[inline]
    fn from(node: AssumeSpecification) -> AnyHasDocComments {
...
impl From<BroadcastUse> for AnyHasDocComments {
    #[inline]
    fn from(node: BroadcastUse) -> AnyHasDocComments { AnyHasDocComments { syntax: node.syntax } }
}
...
impl From<VerusGlobal> for AnyHasDocComments {
    #[inline]
    fn from(node: VerusGlobal) -> AnyHasDocComments { AnyHasDocComments { syntax: node.syntax } }
}
