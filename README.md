...
Verus-analyzer-rebased is a version of [rust-analyzer](https://github.com/rust-lang/rust-analyzer) that has
...
## WARNING!
[Unofficial fork](https://github.com/rikosellic/verus-analyzer) of [verus-lang/verus-analyzer](https://github.com/verus-lang/verus-analyzer) rebased onto a newer rust-analyzer base; not affiliated with the upstream Verus team.
...
instead prefer to have it invoke `cargo verus`, toggle the setting: "Verus-analyzer 鈥?Cargo: Verus Enable".
...
They show up as light bulb (馃挕) icons in the IDE when you hover over a failed proof.
...
so that a "light bulb" 馃挕 will appear and allow you to perform the corresponding
