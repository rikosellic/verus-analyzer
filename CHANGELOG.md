...
### Changed
- **Rebased fork:** the Verus-specific feature set was rebased onto a
  newer rust-analyzer base via vibe coding. Maintained by @rikosellic as
  an independent, unofficial fork; published to the VS Code Marketplace
  under the name `verus-analyzer-rebased`.
